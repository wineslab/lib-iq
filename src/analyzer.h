...
public:
    ...
    //void generate_IQ_Scatterplot(const std::string& input_file_path);
    std::vector<std::vector<double>> generate_IQ_Spectrogram(const std::string& input_file_path, int overlap, int windowsize);
